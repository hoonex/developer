...
- **run #537**: on the initial desktop mixed-geometry/import head, core-tests and all three GPU parity smokes completed successfully; Windows desktop compile/check and app unit tests also completed successfully before a newer documentation head superseded cache cleanup;
